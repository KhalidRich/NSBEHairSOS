...
options.consumer_key = "Um__FlVUdjQ0k7krsp4gng"
options.consumer_secret = "WkIlFun9z-M4S2QBok7FZt4tViY"
options.token = "flXNU9V16GdnnUKlSfAW5LSbecAkiONq"
options.token_secret = "JwO2BzJR3KhfzB4akNEyhliIk4E"
print args
